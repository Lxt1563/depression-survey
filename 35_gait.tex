...
It is the principal acquisition equipment in all investigations of gait auxiliary depression diagnosis. The collection scheme is shown in Fig~\ref{kinect}.
...
In traditional research of gait auxiliary depression diagnosis, hand-crafted features are regularly used together with machine learning classifiers. The gait features are generally divided into two main categories: time-frequency and spatial geometric features.
