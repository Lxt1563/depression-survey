...
\begin{abstract}
Depression is a common mental illness that hassevere adverse effects on individual and society. Traditionalmethods of depression diagnosis require a high degree of cooperation between professional doctors and patients, and are easilyinfluenced by subjective factors. Therefore, it is essential to findan efficient and convenient diagnostic method for depression. Inrecent years, many auxiliary depression diagnosis studies haveexplored different data modalities and made promising progress.Considering the rapid evolution of this field, this paper aims toprovide a comprehensive survey of recent advances in auxiliarydepression diagnosis. 
