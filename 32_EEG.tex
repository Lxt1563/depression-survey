...
\caption{ Some machine learning methods based EEG applied auxiliary depression diagnosis and their performance..}
\label{tab_eeg}
...
\begin{table*}[!htbp]\Large
\caption{
Some machine learning methods based HRV applied auxiliary depression diagnosis and their performance.}
\label{tab_ecg}
\renewcommand\arraystretch{1.5}
%\resizebox{\linewidth}{!}{
\resizebox{0.9999\linewidth}{!}{
