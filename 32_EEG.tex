...
\section{Electrophysiological signals}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
&Cukic et al~\cite{cukic2018eeg} & 43(23+20) & LR & 97.56  \\ \cline{2-5}
...
& Byuna et al~\cite{byun2019detection}& 72(31+41)  & SVM& 74.40  \\ \cline{2-5}
%& &   & SVM  & 74.40     \\
...
By comparing the performance of several approaches on the same datasets, we obtain the following four observations:
