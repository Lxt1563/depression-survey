...
Most depression recognition methods based on multimodal data mostly use audio, video and text data, because the international competition AVEC introduced audiovisual depression analysis in 2013, and compared with other, it is easy to collect.
...
The author~\cite{10.1145/2661806.2661807} believes that the good results of depression recognition may be attributed to the following reasons:
