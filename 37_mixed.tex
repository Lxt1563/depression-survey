...
Kachele et al.~\cite{M2014Fusion} & AVEC2013& SVR & A+V & - & - & - & 8.97 & 10.82 \\ \hline
...
AVEC2014~\cite{10.1145/2661806.2661807} &AVEC2014 &SVR &A+V & -  & -  & -  & 7.89 & 9.89\\ \hline
...
Lau et al.~\cite{lau2021improving} & DAIC-WOZ & Bi-directional LSTM & A+T &92.00 & 100.00 & 86.00 &3.95 &3.00\\\hline
...
\multirow{3}{*}{Ray et al.~\cite{ray2019multi}}  & \multirow{3}{*}{\makecell{E-DAIC+\\DAIC-WOZ}} & \multirow{3}{*}{LSTM}  & V+T                       & - & -  & -  & 4.64 & -   \\
& & & A+T& -  & -  & - & 4.37 & -  \\
& &  & A+V+T  & - & - & -  & 4.28 & -  \\\hline
\end{tabular}
		\begin{tablenotes}
...
Valstar  ~\cite{10.1145/2661806.2661807} believe that the good results of depression recognition may be attributed to the following reasons:
...
Jing et al.~\cite{jing2019different} build a supervised regression model based on individual language and natural gait data to predict depression and anxiety in patients. Their results could be the basis of both applications and future studies on multi-source data fusion in anxiety and depression recognition.
