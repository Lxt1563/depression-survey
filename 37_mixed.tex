...
\section{Depression recognition method based on multiple audiovisual and text data}
...
\subsection{Multiple audiovisual and text depression recognition based on traditional machine learning}
\label{sec_fquality}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\subsection{Multiple audiovisual and text depression recognition based on deep learning}
\label{sec_fquality}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
