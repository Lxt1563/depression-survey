...
Most depression recognition methods based on multimodal data mostly use audio, video, and text data because the international competition AVEC introduced audiovisual depression analysis in 2013. Compared with other modality data, it is easy to collect~\cite{2021Deep}.
