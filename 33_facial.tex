...
\subsection{Depression recognition method based on facial expression}
\label{sec_fquality}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\subsubsection{Facial expression depression recognition based on traditional machine learning}
\label{sec_fquality}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\hline
AVEC2013 baseline~\cite{10.1145/2512530.2512533} & AVEC2013(AViD-Corpus) & SVR             & 13.61         & 10.88        \\
AVEC2014 baseline~\cite{10.1145/2661806.2661807} & AVEC2014(AViD-Corpus) & SVR             & 10.86         & 8.86         \\
Kaya et al~\cite{2014Eyes}                       & AVEC2013(AViD-Corpus) & 1-NN regressor  & 9.72          & 7.86         \\
Jan et al~\cite{ 2014Automatic}                  & AVEC2014(AViD-Corpus) & LR              & 10.5          & 8.44         \\
Wen et al~\cite{2015Automated}                   & AVEC2013(AViD-Corpus) & SVR             & 10.27         & 8.22         \\
AVEC2016/2017 baseline~\cite{valstar2016avec}    & AVEC2016(DAIC-WOZ)    & RF              & 6.97          & 6.12         \\
%AVEC2017 baseline~\cite{ringeval2017avec}        & AVEC2017(DAIC-WOZ)    & RF              & 6.97          & 6.12         \\
Yu et al~\cite{2017Automated}                    & AVEC2013(AViD-Corpus) & CNN             & 9.82          & 7.58         \\
Yu et al ~\cite{2017Automated}                   & AVEC2014(AViD-Corpus) & CNN             & 9.55          & 7.47         \\
AVEC2019 baseline~\cite{ ringeval2019avec}       & AVEC2019(E-DAIC)      & CNN             & 8.01          & -            \\
Melo et al.~\cite{2019Combining}                 & AVEC2013(AViD-Corpus) & CNN             & 8.26          & 6.40         \\
Melo et al.~\cite{2019Combining}                 & AVEC2014(AViD-Corpus) & CNN             & 8.31          & 6.59         \\
Ray et al.~\cite{ray2019multi}                   & AVEC2019(E-DAIC)      & LSTM            & 8.95          & -            \\
Melo et al ~\cite{2019Depression2}               & AVEC2013(AViD-Corpus) & CNN             & 8.25          & 6.30         \\
Melo et al~\cite{2019Depression2}                & AVEC2014(AViD-Corpus) & CNN             & 8.23          & 6.15         \\
Zhou et al~\cite{2019Learning}                   & AVEC2014(AViD-Corpus) & CNN             & 8.43          & 6.37         \\
Melo et al ~\cite{2020A}                        & AVEC2013(AViD-Corpus) & 3D-CNN          & 7.90          & 5.98         \\
Melo et al ~\cite{2020A}                        & AVEC2014(AViD-Corpus) & 3D-CNN          & 7.61          & 5.82         \\
Zhou et al~\cite{2020visually}                   & AVEC2013(AViD-Corpus) & CNN             & 8.28          & 6.20         \\
Zhou et al ~\cite{2020visually}                  & AVEC2014(AViD-Corpus) & CNN             & 8.39          & 6.21         \\
Melo et al ~\cite{2020Encoding}                  & AVEC2013(AViD-Corpus) & 3D-CNN          & 7.97          & 5.96         \\
Melo et al ~\cite{2020Encoding}                  & AVEC2014(AViD-Corpus) & 3D-CNN          & 7.94          & 6.20         \\
Jazaery et al~\cite{8466881}                     & AVEC2013(AViD-Corpus) & RNN-C3D         & 9.28          & 7.37         \\
Jazaery et al ~\cite{8466881}                    & AVEC2014(AViD-Corpus) & RNN-C3D         & 9.20          & 7.22        \\
\hline
