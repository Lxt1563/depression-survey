...
\subsubsection{Speech auxiliary depression diagnosis based
on deep learning}
...
% \usepackage{booktabs}
\begin{table*}
\caption{Overview of traditional machine learning methods for auxiliary depression diagnosis from Speech.}
\label{tab_1}
\resizebox{\linewidth}{!}{
\begin{tabular}{@{}ccccc@{}}
\hline
...
\begin{table*}
\caption{ Overview of deep machine learning methods for auxiliary depression diagnosis from Speech.}
\label{tab_2}
\resizebox{\linewidth}{!}{
