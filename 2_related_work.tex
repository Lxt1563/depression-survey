...
It is characterized by its simplicity of use and ability to reflect fairly visually the subjective feelings of depressed patients and their changes in treatment.
...
Although various methods have been proposed for auxiliary depression diagnosis based on different multimodal data, the procedure for predicting depression in these methods are uniform, as shown in Fig \ref{method}.
...
Feature extraction includes hand-crafted or data-driven.
...
\subsubsection{Prediction} Auxiliary depression diagnostic models based on different modality data are divided into traditional machine learning methods and deep learning methods.
Traditional machine learning method inputs the hand-crafted extracted features into a linear or nonlinear classifier for prediction, such as Support Vector Machine (SVM), Support Vector Regression (SVR), Random Forests (RF), Logistic Regression (LR), etc.
