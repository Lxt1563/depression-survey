...
Since deep learning technology can automatically construct text features, people have proposed CNN, RNN, and hybrid models to solve the problem of depression analysis based on social media text~\cite{yates2017depression,shen2017depression,orabi2018deep,ive2018hierarchical}.

Deep Neural Network (DNN) is the basis of many modern artificial intelligence applications and has shown advantage in semantic inference tasks.
...
\hline
\textbf{Paper}  & \textbf{Media}     & \textbf{Dataset(D+C)}            & \textbf{Methods}           & \textbf{F1-Score}                                                                                           \\
\hline
...
The performance of text auxiliary depression diagnosis approaches is presented in Tabel~\ref{tab5}.
...
The results show that the hybrid model works better than the individual models, and waiting for more data before making a decision improves the traditional performance measures.
