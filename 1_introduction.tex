...
{\color{red}
Depression's clinical manifestations include slower movement and speech, which can be caught audiovisually and serve as a valid tool for auxiliary depression diagnosis.}
%{\color{red}
...
(3) We summarize and analyze the advantages and disadvantages of different data modalities for auxiliary depression diagnosis and give insights on promising research directions in this field.
