...
Persistent grief, losing interest in things that are usually enjoyed, and the inability to participate in daily activities are characteristics of depression~\cite{peveler2002depression}.
...
There is currently a severe shortage of medical professionals and medical resources for diagnosing and treating depression.
Up to 75\% of patients, especially in low-income and middle-income countries, do not obtain early diagnosis and treatment.
...
\caption{The taxonomy of depression recognation with data modality.}
...
The following advantages exist for machine learning-based depression recognition:
(1) High efficiency: by using computer technology to analyze the physiological signals of depressed patients and create objective diagnostic indicators, clinical diagnosis can be made much more quickly and effectively.
(2) Low interference: the machine learning method is used for automatically auxiliary depression diagnosis, which eliminates the need for professionals to observe consciousness and lessens the difficulties of diagnosing and treating depression owing to patient resistance.

Despite the rapid evolution in this field, there is yet no systematic study to review and discuss existing progress.
To fill this gap, we conduct a thorough analysis of recent depression recognition studies about the use of machine learning on data modality.
Next, the research methodology and procedures of machine learning in auxiliary depression diagnosis are outlined, and finally, the research directions and challenges for the future are presented.
As shown in Fig~\ref{Taxonomy}, we focus on the progress of the methods and potential research directions in five data modalities:~\emph{brain imaging}~\cite{schnyer2017evaluating,sato2015machine,ramasubbu2016accuracy,vai2020predicting,wei2021functional},  \emph{electrophysiological signals}~\cite{nilsonne2021eeg,shim2019machine,jiang2016predictability,li2016classification,kim2018automatic}, \emph{Audiovisual data}~\cite{ma2016depaudionet,zhou2018visually,miao2021automatic},
...
They have been widely utilized to treat auxiliary depression diagnosis due to their non-invasive detection and simplicity of use.
...
%{\color{red}
Depression's clinical manifestations include slower movement and speech, which can be caught audio visually and serve as a valid tool for depression recognition.%}
%{\color{red}
...
(5) \emph{Mixed:}
In addition to utilizing single physiological or behavioural data for depression recognition, many studies have sought to employ mixed data for this task~\cite{lalousis2021heterogeneity,meng2021bidirectional,toenders2022predicting}.
...
\caption{Common physiological signals: subgraphs $a-c$ represent brain imaging, electrophysiological signals, and audiovisual data, respectively.}
...
In this paper, we review the current state of research on machine learning in depression recognition regarding the five data modalities mentioned above, focusing on the progress and potential research directions of using machine learning techniques in their contexts.
The main contributions of this study lie in three folds.

(1) To the best of our knowledge, this is the first comprehensive survey about depression recognition on different data modalities, which will provide researchers and clinical psychologists with a better understanding of the use of machine learning in this area.

(2) We provide an in-depth review of advanced depression recognition studies, and compare the performance of different methods in each data modality.

(3) We provide a summary and analysis of the pros and cons of several depression recognition methods, as well as insights into prospective research prospects in this field.
%We summarize and analyze the advantages and disadvantages of different methods for depression recognition and give insights on promising research directions in this field.

The rest of this survey will be organized as follows:
Section 2 introduces some basic knowledge in depression recognition task including scales, datasets and assessment metrics.
%{\color{red}
%Section 2 presents a summary of standard approaches to diagnosing clinical depression and abnormal changes in the physiology and behaviour of depressed patients and introduces widely-used questionnaires, datasets, and metrics.
%}
Section 3-7 provides an in-depth analysis of machine learning-based approaches to depression diagnosis from the perspective of different data modalities.
