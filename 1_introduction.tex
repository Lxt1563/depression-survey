...
To address the difficulty of clinical diagnosis of depression, in recent years, researchers propose massive machine learning approaches.
...
In the previous period, there were many machine learning methods for auxiliary depression diagnosis, and they achieved better performance.
...
In this paper, we review the current state of research on machine learning in auxiliary depression diagnosis regarding the five data modalities mentioned above.
